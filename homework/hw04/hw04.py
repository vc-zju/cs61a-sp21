...
def replace_thor_at_leaf(t, thors_replacement):
    ...
    True
    """
    return tree(thors_replacement if is_leaf(t) and label(t) == "thor" else label(t), \
...
def multiple_references_explanation():
    return """An uncertain value is used by multiple times, 
            which induces greater calculation error."""
