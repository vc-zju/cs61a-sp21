...
def piggy_points(score):
    ...
    score **= 2
    while score != 0:
        min_value = min(min_value, score % 10)
        score //= 10
    return min_value + 3
    # END PROBLEM 2
...
def get_left_two_digit(num):
    """Return the leftmost digit and the second leftmost digit.
    If num < 10, the leftmost digit is 0.

    num: The input number

    >>> get_left_two_digit(7)
    (0, 7)
    >>> get_left_two_digit(17123)
    (1, 7)
    >>> get_left_two_digit(32)
    (3, 2)
    """
    while num >= 100:
        num //= 10
...
def more_boar(player_score, opponent_score):
    ...
    """
    # BEGIN PROBLEM 4
    player_digits = get_left_two_digit(player_score)
    opponent_digits = get_left_two_digit(opponent_score)
    return player_digits[0] < opponent_digits[0] and player_digits[1] < opponent_digits[1]
    # END PROBLEM 4
